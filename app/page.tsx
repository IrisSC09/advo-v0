...
import { ArrowRight, Users, MessageCircle, TrendingUp, Sparkles, Brain, Megaphone, Star, Quote } from "lucide-react"
...
export default function HomePage() {
  ...
  const impactStats = [
    { label: "Active Users", value: "47.2K", icon: Users, color: "text-advoline-orange" },
    { label: "Current Threads", value: "12.8K", icon: MessageCircle, color: "text-neon-purple" },
    { label: "Decisions Impacted", value: "234", icon: TrendingUp, color: "text-green-500" },
  ]
      ...
      <div className="min-h-screen bg-black">
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto font-light leading-relaxed">
                We believe democracy works best when everyone has access to clear, unbiased information and the tools to
        ...
        <section className="py-20 bg-gray-900">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-black text-white mb-6">
                REAL <span className="text-neon-purple neon-glow font-extralight">IMPACT</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto font-light leading-relaxed">
                Join thousands of advocates who are already making a difference in their communities and beyond.
              </p>
            </div>
              ...
              <Card className="bg-black border-advoline-orange max-w-2xl mx-auto">
                <CardContent className="p-8">
                  <div className="flex items-center justify-center gap-2 mb-4">
                    ...
                    <span className="text-advoline-orange font-bold text-lg">Latest Achievement</span>
                  </div>
                  <p className="text-white text-xl font-semibold mb-2">
                    Community advocacy led to $2.3M in additional education funding
                  </p>
                  <p className="text-gray-400">
                    Through coordinated threads and direct outreach, our community successfully influenced local budget
                    decisions.
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="py-20 bg-black">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-black text-white mb-6">
                WHAT ADVOCATES <span className="text-advoline-orange text-glow font-extralight">SAY</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto font-light leading-relaxed">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center gap-1 mb-4">
                      {[...Array(review.rating)].map((_, i) => (
                        <Star key={i} className="h-4 w-4 fill-advoline-orange text-advoline-orange" />
                      ))}
                    </div>
        ...
        <section className="py-20 bg-gray-900">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-300 mb-12 font-light leading-relaxed">
              Join the movement. Start creating. Drive change. It's completely free to get started.
            </p>
            ...
            <p className="text-gray-400">No credit card required • Join 47,000+ advocates • Cancel anytime</p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="flex items-center space-x-3 mb-4 md:mb-0">
                ...
                <div className="text-sm font-light neon-glow tracking-wide text-purple-300">
