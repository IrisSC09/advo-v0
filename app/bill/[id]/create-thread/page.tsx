...
import { ArrowLeft, Upload, FileText, Music, Palette, BookOpen, X } from "lucide-react"
...
export default function CreateThreadPage() {
  ...
  const threadTypes = [
    { value: "zine", label: "Zine", icon: FileText, description: "Digital magazines, comics, or visual stories" },
    { value: "art", label: "Art", icon: Palette, description: "Posters, illustrations, or visual activism" },
    { value: "music", label: "Music", icon: Music, description: "Songs, beats, or audio content" },
    { value: "blog", label: "Blog", icon: BookOpen, description: "Written articles or opinion pieces" },
  ]
      ...
      <div className="min-h-screen bg-black pt-20 flex items-center justify-center">
        <Card className="bg-gray-900 border-gray-800 max-w-md">
          <CardContent className="p-8 text-center">
            <h2 className="text-white text-xl font-bold mb-4">Sign In Required</h2>
  ...
  return (
    <div className="min-h-screen bg-black pt-20">
      <div className="max-w-4xl mx-auto px-4 py-8">
        {/* Back Button */}
        <Link href={`/bill/${billId}`} className="inline-flex items-center text-gray-400 hover:text-white mb-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-lg">
            Share your creative take on this legislation. Create zines, art, music, or blogs to make politics
            accessible.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-white font-medium">{threadType.label}</span>
                          </div>
                          <p className="text-gray-400 text-sm">{threadType.description}</p>
                        </div>
                      )
                    })}
                  </div>
              ...
              <Card className="bg-gray-900 border-gray-800">
                <CardHeader>
                  <CardTitle className="text-white">Upload File (Optional)</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="border-2 border-dashed border-gray-700 rounded-lg p-6 text-center">
                    ...
                    <label htmlFor="file-upload" className="cursor-pointer">
                      ...
                      <p className="text-gray-500 text-sm">Images, audio, PDFs, or documents (max 10MB)</p>
                    </label>
                  </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="bg-gray-900 border-gray-800">
                ...
                <CardContent>
                  <div className="flex gap-2 mb-3">
                    ...
                    />
                    <Button type="button" onClick={addTag} disabled={!newTag.trim() || tags.length >= 5}>
                      Add
                    </Button>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {tags.map((tag) => (
                      <Badge key={tag} className="bg-advoline-orange text-black">
                        #{tag}
                  ...
                  <p className="text-gray-500 text-sm mt-2">Add up to 5 tags to help others discover your thread</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gray-900 border-gray-800">
                <CardContent className="p-6">
                  ...
                  <Button
                    type="submit"
                    disabled={loading || !title.trim() || !content.trim() || !type}
